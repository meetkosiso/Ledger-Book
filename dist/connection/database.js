...
exports.disconnectTestDatabase = exports.connectTestDatabase = exports.databaseConnection = void 0;
...
function connectTestDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield mongoose_1.default.connect(mongoServer.getUri(), { dbName: "test" });
    });
}
exports.connectTestDatabase = connectTestDatabase;
function disconnectTestDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
